...
const HeadlineLeftText: FC<{ block: HeadlineTextInterface }> = ({ block }) => {
  ...
  const leftText = `${styles.leftText} ${block?.background_image ? '' : styles.extraPadding}`
  const descriptionLeft = `${styles.description} ${styles.descriptionLeft} typo-body`
...
export default HeadlineLeftText
