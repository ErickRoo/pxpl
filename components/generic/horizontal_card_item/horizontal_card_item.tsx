...
const HorizontalCardItem: FunctionComponent<{ oneItem: HorizontalCardItemInterface }> = ({ oneItem }) => {
  if (!oneItem) {
    return null
  }
  ...
  return (
    <div className={`${styles.wrapper} ${oneItem.imageAlignment === 'right' ? styles.wrapper__right : ''}`}>
